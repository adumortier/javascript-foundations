...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    var werewolf = new Werewolf('bree')
  ...
  it('should be able to eat(victim) once hungry', function() {
    var werewolf = new Werewolf('bree')
    var person = new Victim('George')
    assert.equal(werewolf.eat(person), "I'm not hungry")
    werewolf.change()
    assert.equal(werewolf.eat(person), "That was delicious")
  });
  ...
  it('should not be able to consume victim in human form', function() {
    ...
    assert.equal(werewolf.human, true)
    assert.equal(werewolf.eat(victim), "I'm not hungry")
  });
});
